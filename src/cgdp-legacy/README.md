...
* nci-analytics-functions

The cgdp-init.js module is a combination of the old R4R initialization function from cgdp, and what is needed for a genericAppModule. This will be exported to the window for the generic app module.